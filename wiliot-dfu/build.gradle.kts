...
group = "com.wiliot"
val archivesBaseName = "wiliot-dfu"
version = extra["dfuVersionName"] as String

android {
    namespace = "com.wiliot.wiliotdfu"
    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                description.set("DFU SDK module for Wiliot Android integration")
