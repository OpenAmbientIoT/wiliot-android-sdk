...
import com.wiliot.wiliotnetworkedge.utils.signedRequest
import okhttp3.Authenticator
import okhttp3.Request
import okhttp3.Response
import okhttp3.Route

class EdgeTokenRefreshAuthenticator(
    ...
    private fun Response.createSignedRequest(): Request? = try {
        val accessToken = WiliotNetworkEdge.configuration.authToken
        ...
        request.signedRequest(WiliotNetworkEdge.configuration.authToken).also {
