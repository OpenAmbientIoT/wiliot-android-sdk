...
group = "com.wiliot"
val archivesBaseName = "wiliot-resolve-data"
version = extra["resolveDataVersionName"] as String

android {
    namespace = "com.wiliot.wiliotresolvedata"
...
mavenPublishing {
    ...
    pom {
        ...
        description.set("Data Resolve SDK module for Wiliot Android integration")
